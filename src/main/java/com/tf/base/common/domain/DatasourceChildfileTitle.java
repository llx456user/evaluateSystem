...
@Table(name = "datasource_childfile_title")
public class DatasourceChildfileTitle {
    /**
     * 主键
     */
    @Id
     ...
     * 获取文件标题ID
     *
     * @return filetitle_id - 文件标题ID
     */
    public Integer getFiletitleId() {
        return filetitleId;
    }
     ...
     * 设置文件标题ID
     *
     * @param filetitleId 文件标题ID
     */
    public void setFiletitleId(Integer filetitleId) {
    ...
    public String toString() {
        ...
        sb.append(", childFileId=").append(childFileId);
        sb.append(", filetitleId=").append(filetitleId);
