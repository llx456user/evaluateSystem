...
public class ProjectIndex {
     ...
     * 指标ID
     */
    @Column(name = "index_child_id")
    private Integer indexChildId;
    ...
    /**
     * 是否叶子节点  1-是  其他不是  临时字段不作为数据库持久化使用
     */
    @Transient
    ...
    public String toString() {
        ...
        sb.append(", indexChildId=").append(indexChildId);
    ...
    public Integer getIndexChildId() {
        return indexChildId;
    }

    public void setIndexChildId(Integer indexChildId) {
        this.indexChildId = indexChildId;
    }
}