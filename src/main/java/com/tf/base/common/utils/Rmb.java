...
public class Rmb {
	...
	static String HanDiviStr[] = new String[] { "    ", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰", "仟", "万",
			                             "拾", "佰", "仟" };
	static String HanDiviStr1[] = new String[] { "", "拾", "佰", "仟", "万", "拾", "佰", "仟",
	...
	public static String NumToRMBChinese(double val) {
		String SignStr = "";
		String TailStr = "";
		long fraction, integer;
		int jiao, fen;
		...
		String rmb = SignStr + PositiveIntegerToHanStr(String.valueOf(integer))
		+ "元" + TailStr;
		rmb = rmb.replaceAll(" ", "");
		return rmb;
	}
