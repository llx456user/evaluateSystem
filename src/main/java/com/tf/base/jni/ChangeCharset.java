...
public class ChangeCharset {
    ...
    public void print(String str) throws UnsupportedEncodingException {
        ...
        System.out.println("转换成US-ASCII码: " + ascii);
        gbk = changeCharset(ascii, ChangeCharset.US_ASCII,
                ChangeCharset.GBK);
        System.out.println("再把ASCII码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String iso88591 =toISO_8859_1(str);
        System.out.println("转换成ISO-8859-1码: " + iso88591);
        gbk = changeCharset(iso88591, ChangeCharset.ISO_8859_1,
                ChangeCharset.GBK);
        System.out.println("再把ISO-8859-1码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf8 = toUTF_8(str);
        System.out.println("转换成UTF-8码: " + utf8);
        gbk = changeCharset(utf8, ChangeCharset.UTF_8, ChangeCharset.GBK);
        System.out.println("再把UTF-8码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf16be = toUTF_16BE(str);
        System.out.println("转换成UTF-16BE码:" + utf16be);
        gbk = changeCharset(utf16be, ChangeCharset.UTF_16BE,
                ChangeCharset.GBK);
        System.out.println("再把UTF-16BE码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf16le = toUTF_16LE(str);
        System.out.println("转换成UTF-16LE码:" + utf16le);
        gbk = changeCharset(utf16le, ChangeCharset.UTF_16LE,
                ChangeCharset.GBK);
        System.out.println("再把UTF-16LE码的字符串转换成GBK码: " + gbk);
        System.out.println();
        String utf16 = toUTF_16(str);
        System.out.println("转换成UTF-16码:" + utf16);
        gbk = changeCharset(utf16, ChangeCharset.UTF_16LE,
                ChangeCharset.GBK);
        System.out.println("再把UTF-16码的字符串转换成GBK码: " + gbk);
        String s = new String("中文".getBytes("UTF-8"), "UTF-8");
        System.out.println(s);
