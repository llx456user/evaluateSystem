		...
		<div class="panel-heading">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="assessName" placeholder="" value="${assessName }">
				</div>
				<div class="form-group">
					<label for="assessContent">评估描述</label>
					<textarea class="form-control" id="assessContent" placeholder="">${assessContent }</textarea>
				</div>
			</div>
		</div>
		<div class="panel-body">
			<nav class="menu" data-ride="menu">
				<ul id="treeMenu" class="tree tree-menu" data-ride="tree">
									...
									<form class="form">
										<c:forEach items="${p.cParamList }" var="c">
											...
											<div class="form-group">
												...
												<input type="hidden" class="form-control" key="${c.id }"
													   name="assessParam"
													   placeholder="" value="${c.projectParamName }">
					...
					<input type="hidden" id="groupParamSuitNUmber" value="${groupParamSuitNUmber}">

					<button class="btn btn-primary" type="button" onclick="groupAssess();">评估</button>
					<button class="btn btn-primary" type="button" onclick="backTemplate();">返回</button>
				</ul>
			</nav>
		</div>
	</div>
