					...
					<c:forEach items="${e.tables }" var="y">
						<c:if test="${e.indexValue!=null&&e.indexValue!='0'}">
							<div class="table-responsive">
								<table class="table table-condensed table-bordered mytable" json='${el:toJsonString(y)}'>
									<tr><td  align="center" style="font-weight: bold" colspan="${y.colspan }">${y.title }</td>
...
<script type="text/javascript">
    ...
    function genLine(id,url){
        ...
        // url = 't'
        loadJs(ctx + "/resources/js/assessdata/225_127_4_line.js?r=" + Math.random(),function(){
            if(datas){
    ...
    function genHline(id,url){
        ...
        loadJs(ctx + "/resources/js/assessdata/241_127_4_line.js?r=" + Math.random(),function(){
            if(datas){
    ...
    function genScatter(id,url){
        ...
        //url = '241_127_2';
        jsurl = ctx + "/resources/js/assessdata/225_127_2_scatter.js?r=" + Math.random()
        loadJs(jsurl,function(){
            if(datas){
                ...
                // }
                initMyChart_scatter(id,datas.title,datas.xtitle,datas.ytitle,datas.loanCounts);
            }
        });
    ...
    function initMyChart_line(id,title,xtitle,ytitle,invNames,loanCounts){
        ...
        }],"legendData":["name","name2"],"title":"title","xtitle":"xtitle","ytitle":"ytitle"};
        option = {
            title : {
                text: d.title
            },
       ...
       /*  var nCounts={};
        ...
        var d = {
                ...
                datas:[{
                    ...
                    hoverAnimation: false,
                    type:'scatter',
                    data:[["103","104"],["104","105"],["105","106"],["106","107"],["107","108"],["108","109"],["109","110"],["110","111"],["111","112"],["112","113"]
