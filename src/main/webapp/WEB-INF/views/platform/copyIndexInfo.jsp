...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/resources/js/platform/copyIndexInfo.js?version=${jsversion}'/>"></script>
    <style>
        .active{
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div style="width: 100%;position: relative;border:1px solid #ddd;">
                <div style="float:left;width:103px;height:780px;border:1px solid #ddd;text-align:center;background:#ddd;">
                    <div class="btn-group">
                    ...
                    <div id="myPaletteDiv" style="height: 280px; margin-top:10px;border: solid 0px gray "></div>
                    <!--去掉常数和if
                ...
                <div id="show" style="height:780px; vertical-align: top; padding: 5px; width:90%; margin-left: 110px;	" ondrop="drop(event)" ondragover="allowDrop(event)">
                </div>
