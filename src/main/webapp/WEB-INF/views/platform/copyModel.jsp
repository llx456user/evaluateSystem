...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/resources/js/platform/copyModel.js'/>"></script>
    <style>
        .active {
        ...
        <div class="panel-heading">
            <form role="form" class="form-inline">
                ...
                <div style="float:right;">
                    ...
                    <button type="button" class="btn btn-primary" onclick="selectMedel();"><i class="icon-plus"></i> 选择模型
                    </button>
                </div>
