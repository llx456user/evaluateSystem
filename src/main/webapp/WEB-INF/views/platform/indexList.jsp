...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/resources/js/platform/indexList.js'/>"></script>
    <style>
        .active {
            ...
            <form role="form" class="form-inline">
                ...
                <div style="float:right;">
                    <div class="form-group">
                        <input type="text" class="form-control" id="parameterKey" placeholder="指标名称">
                        <input type="text" class="form-control" id="indexContent" placeholder="指标内容">
                    </div>
                    <button type="button" class="btn btn-default" onclick="search();">搜索</button>
                    <button type="button" class="btn btn-primary" onclick="addEditIndex();"><i class="icon-plus"></i> 新建指标
                    </button>
                </div>
            </form>
        </div>
