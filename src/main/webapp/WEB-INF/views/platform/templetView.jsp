	    ...
	    <div class="panel-body">
			<form>
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="templetName" placeholder="" disabled="disabled" value="${info.templetName }">
			  </div>
			  <div class="form-group">
			    <label for="templetContent">模板内容</label>
			    <textarea class="form-control" id="templetContent" placeholder="" disabled="disabled" >${info.templetContent }</textarea>
			  </div>
		...
		<div class="panel-body">
			<div style="width: 100%;position: relative;border:1px solid #ddd;">
				<div style="float:left;width:103px;height:680px;border:1px solid #ddd;text-align:center;background:#ddd;">
					<div class="btn-group">
						<div class="indexBtnImg dropdown-toggle" data-toggle="dropdown" style="margin-right:6px;">
							<strong>模型</strong>
						</div>
