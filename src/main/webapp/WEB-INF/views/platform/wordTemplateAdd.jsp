...
<head>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/platform/docTemplateList.js?version=${jsversion}'/>"></script>
	<style>
	.active{
	...
	<div class="container">
	    ...
	    <div class="panel-body">
			<form id="fileEditForm" method="post">
			 ...
			 <button class="btn btn-primary" type="button" onclick="saveWordTemplate();">保存</button>
