...
<div class="container">
    ...
    <div class="panel" style="margin-bottom: 5px;">
        <div class="panel-heading">
            <strong>${projectName}数据信息</strong>
        </div>
        <div class="panel-body">
            <form id="fileEditForm" method="post">
                <input type="hidden" name="id" id="id" value="${projectId }"/>
                <input type="hidden" name="dataName" id="groupDataName" value="${dataName }"/>
                <input type="hidden" name="groupDataComment" id="groupDataComment" value="${dataComment }"/>
                ...
                <div class="form-group">
                    <label>数据名称</label>
                    <input type="text" class="form-control" id="dataName" name="dataName" placeholder="">
                </div>
                <div class="form-group">
                    <label>数据备注</label>
                    <textarea class="form-control" id="dataComment" name="dataComment" placeholder=""></textarea>
                </div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <c:forEach items="${inparList }" var="in" varStatus="stat">
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" class="form-control" name="projectParamId" value="${in.id }">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="paramValue" onkeyup="value=value.replace(/[^\-?\d.]/g,'')">
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                        ...
                        <tbody id="optVariableTb">
                            <c:forEach items="${outparList }" var="out" varStatus="stat">
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" class="form-control" name="projectParamId" value="${out.id }">
                                        <input type="hidden" class="form-control" name="fileValueAndName">
                                    </td>
                                    <td>
...
<script type="text/javascript">
    ...
    function save(){
        ...
        var groupDataComment = $("#groupDataComment").val().trim();
        var groupDataName = $("#groupDataName").val().trim();
        var dataTemplateNumber = $("#dataTemplateNumber").val().trim();
        ...
        var param = {
            ...
            groupDataComment:groupDataComment,
        ...
        //return;
        $.ajax({
            url:ctx + '/project/saveGroupSetProjectParam',
