...
<body>
	...
	<!-- 选择指标 -->
		<div class="panel" style="margin-bottom: 5px;" id="multiDroppableContainer">
			...
			<div class="panel-body">
				...
				<button class="btn btn-primary" type="button" onclick="viewIndex();">预览指标树</button>
			</div>
		...
		<div class="panel" style="margin-bottom: 5px;">
			...
			<div class="panel-body">
				<form id="fileEditForm" method="post">
					...
					<div class="form-group">
						<label for="projectContent">项目内容</label>
	...
	<div class="modal fade" id="addIndexPage">
					...
					<table style="margin: 0 auto;">
						<tr>
							...
							<td style="width: 300px;">
								<input type="text" autofocus="autofocus" class="form-control" name="indexName" style="width: 300px;"/>
							</td>
						</tr>
						<!--<tr>
							<td>备注</td>
		...
		<!-- 修改指标名称 -->
		<div class="modal fade" id="updateIndexName">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">关闭</span></button>
						<h4 class="modal-title">修改指标名称</h4>
					</div>
					<div class="modal-body">
						<p>
						<table style="margin: 0 auto;">
	...
	<!-- 设置权重 -->
	<div class="modal fade" id="setWeightCurrentPage">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">关闭</span></button>
					<h4 class="modal-title">设置权重</h4>
				</div>
				<div class="modal-body">
					<p>
					<table style="margin: 0 auto;">
						<tr>
							<td>权重</td>
							<td style="width: 300px;">
								<input type="text" class="form-control" name="weightCurrent" style="width: 300px;"/>
							</td>
						</tr>
					</table>
					</p>
