...
function generateTreeMenu() {
    $.post(ctx + "/platform/modelcategoryList", function (resultData) {
        ...
        other: {
            ...
            data: {
                cols: [
                    ...
                    {field: 'modelName', title: '模型名称', width: 110, halign: 'center', align: 'center'},
                    {field: 'modelStatusStr', title: '模型版本', width: 50, halign: 'center', align: 'center'},
                    {field: 'modelContent', title: '模型内容', width: 80, halign: 'center', align: 'center'},
                    {
...
function selectMedel() {
    ...
    var modelframeid = $("#modelframeid").val();
    var category = $("#category").val();
    top.document.getElementById(modelframeid).contentWindow.callBackSetModel(value,category);
    top.closeDialog();
