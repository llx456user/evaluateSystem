...
function save() {
    var templetName= document.getElementById("templetName").value;
    var templetContent=document.getElementById("templetContent").value;
    var categoryId=document.getElementById("categoryId").value;
    var id=document.getElementById("templetId").value;
...
function drop(ev) {
  ...
  if(id=='gridBtn'){//图形结束，表格
        ...
        myDiagram.commitTransaction("add grid");
         ...
         selectFile(id,type,ev.dataTransfer.getData("fileName"),nodeDataArray);
      }else if(type=="sql"){
        selectFile(id,type,ev.dataTransfer.getData("fileName"),nodeDataArray);
      }else if (type == 'bar') {//图形
